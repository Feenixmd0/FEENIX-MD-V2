...
kasun({ nomCom: "developer", categorie: "General", reaction: "🐐" }, async (dest, zk, commandeOptions) => {
    const { ms, mybotpic } = commandeOptions;

    const devs = [
      { nom: "MR KASUN", numero: "94772801923" },
      { nom: "᚛KASUNSANDEEPA᚜", numero: "94772801923" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "👋 *Welcome to FEENIX-Md!* here is the developer numbers:\n\n";
...
france({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  await zk.sendMessage(auteurMessage,{text : `https://wa.me/+94772801923`},{quoted :ms})
